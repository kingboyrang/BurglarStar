...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _cancel.frame=CGRectMake((frame.size.width/2-size.width)/2,(frame.size.height-size.height)/2+5, size.width, size.height);
        ...
        _submit.frame=CGRectMake(frame.size.width/2+(frame.size.width/2-size.width)/2, (frame.size.height-size.height)/2+5, size.width, size.height);
